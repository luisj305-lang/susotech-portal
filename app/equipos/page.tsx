...
export default async function CrewsPage() {
  ...
  return <main className="min-h-screen bg-black px-4 py-8 text-white sm:px-8"><div className="mx-auto max-w-6xl">
    ...
    <header className="my-6"><p className="text-sm font-semibold uppercase tracking-widest text-white">Operaciones</p><h1 className="text-3xl font-bold">Equipos</h1><p className="mt-1 text-white">Organiza responsables e integrantes para asignar trabajos.</p></header>
