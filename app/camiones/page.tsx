...
import { createFleetVehicleAction } from "@/lib/fleet/actions";
import { listFleetVehicles } from "@/lib/fleet/queries";
...
export default async function FleetPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  const vehicles = await listFleetVehicles({ query, status });
